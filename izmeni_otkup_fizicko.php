...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary"> Измени податоци за откуп за физичко лице </h6>
  </div>
  <div class="card-body">
<?php
...
<form action="code_izmeni_otkup_fizicko.php" method="POST">
...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="edit_sortaotkupfizicko" class="form-control" value="<?php echo $row['sortaotkupfizicko'] ?>">
    </div>
    <div class="form-group">
        <label>Бруто:</label>
    ...
    <div class="form-group">
        <label>Шеќер %:</label>
        <input type="text" name="edit_sekerf" class="form-control" value="<?php echo $row['sekerf'] ?>">
    </div>
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="edit_provizijazaotkup" class="form-control">
              ...
              <button type="submit" name="izmenifizickiotkup" class="btn btn-primary"> ИЗМЕНИ </button>
