...
<?php
  $izberifiz = $_POST["izberifiz"];
  if($izberifiz) {
    $izborfiz = $_POST["logfizicki"];
  }
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
<form action="processnovotkupfizicko.php" method="POST">
...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="sortaotkupfizicko" class="form-control">
    </div>
    <div class="form-group">
        <label>Бруто:</label>
    ...
    <div class="form-group">
        <label>Шеќер %:</label>
        <input type="text" name="sekerf" class="form-control">
    </div>
   <div class="form-group">
    ...
    <?php echo "<input type = 'text' name = 'sopstvenikid' style = 'display:none;' value = '$izborfiz'/>"; ?>
</div>
